...
const Hero = () => {
    return (
      ...
      <div className="lg: container flex flex-col items-center content-center justify-center z-40 absolute">
          ...
          <h1 className="text-4xl outline-none border-black text-white  mb-2  z-5 md:text-5xl z-5 lg:text-5xl text-center font-mel pb-4">Transform into the person <br/> you were born to be  </h1>
